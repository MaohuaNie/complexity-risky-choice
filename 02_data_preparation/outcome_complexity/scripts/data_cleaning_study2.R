# ============================================================================
# data_cleaning_study2.R — raw -> analysis-ready data for Study 2 (outcome_complexity / arithmetic expressions)
#
# Aim:     Build the analysis-ready dataset from the raw experiment export,
#          applying the documented participant/trial exclusions.
# Inputs:  outcome_complexity/data/merged_data.rds (raw merged jsPsych export)
#          outcome_complexity/data/test_trial_study2_raw.csv (stimulus table)
# Outputs: outcome_complexity/data/derived/result_ca_study2.rds
#          outcome_complexity/data/derived/exclusion_report_study2.rds
#          outcome_complexity/data/derived/final_df_study2.rds
# Exclusions (in order):
...
# ---- project root ----
here::i_am("outcome_complexity/scripts/data_cleaning_study2.R")

# ---- inputs (match your folder structure) ----
IN_RDS       <- here::here("outcome_complexity","data", "merged_data.rds")
IN_STIM_CSV  <- here::here("outcome_complexity","data", "test_trial_study2_raw.csv")
DERIVED_DIR  <- here::here("outcome_complexity","data", "derived")
fs::dir_create(DERIVED_DIR)

# ---- load merged data (RDS only, per your structure) ----
...
saveRDS(result_ca, here::here("outcome_complexity","data", "derived", "result_ca_study2.rds"))
...
saveRDS(exclusion_report, file.path("outcome_complexity","data", "derived", "exclusion_report_study2.rds"))
...
data_exclusion <- data_exclusion %>%
  mutate(
    ...
    trial_index_raw  = dplyr::if_else(skew == "cn", trial_index_base + 45L, trial_index_base)
  )
...
# Save outputs
# =========================================================
saveRDS(final_df, here::here("outcome_complexity","data", "derived", "final_df_study2.rds"))