...
parameters {
  vector[7] mu;                                     // population-level means for beta, theta, threshold, ndt, gamma, sp, delta_gamma
...
transformed parameters {
  matrix[7, L] participant_params;                  // participant-specific parameters (beta, theta, threshold, ndt, gamma, sp, delta_gamma)
