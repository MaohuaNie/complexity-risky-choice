...
parameters {
  vector[6] mu;                                     // population-level means for beta, theta, threshold, ndt, gamma, sp
...
transformed parameters {
  matrix[6, L] participant_params;                  // participant-specific parameters (beta, theta, threshold, ndt, gamma, sp)
  ...
  for (n in 1:N) {
    ...
    // Compute utilities for options complex and simple
