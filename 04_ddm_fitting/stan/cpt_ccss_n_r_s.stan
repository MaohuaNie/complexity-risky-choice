...
parameters {
  vector[8] mu;                                     // population-level means for beta, theta, threshold, ndt, gamma, delta_beta, delta_theta, delta_gamma
...
transformed parameters {
  matrix[8, L] participant_params;                  // participant-specific parameters (beta, theta, threshold, ndt, gamma, delta_beta, delta_theta, delta_gamma)
