...
parameters {
  vector[6] mu;                                     // population-level means for beta, theta, threshold, ndt, gamma, delta_gamma
...
transformed parameters {
  matrix[6, L] participant_params;                  // participant-specific parameters (beta, theta, threshold, ndt, gamma, delta_gamma)
...
model {
  ...
  mu[6] ~ normal(0, 3);  // Prior for delta_gamma's population mean
