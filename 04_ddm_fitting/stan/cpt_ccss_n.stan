...
parameters {
  vector[6] mu;                                     // population-level means for beta, theta, threshold, ndt, gamma, delta_theta
...
transformed parameters {
  matrix[6, L] participant_params;                  // participant-specific parameters (beta, theta, threshold, ndt, gamma, delta_theta)
