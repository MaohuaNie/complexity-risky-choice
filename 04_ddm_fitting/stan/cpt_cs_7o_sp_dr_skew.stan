...
parameters {
  ...
  cholesky_factor_corr[8] L_corr;
  matrix[8, L] z;
}

transformed parameters {
  matrix[8, L] participant_params;
  vector[L] beta_t;
  vector[L] theta_t;
  ...
  for (n in 1:N) {
    ...
    real w1c = pweight(p_complex[n, 1], gamma_complex);
    real w2c = pweight(p_complex[n, 1] + p_complex[n, 2], gamma_complex) - w1c;
    real w3c = pweight(p_complex[n, 1] + p_complex[n, 2] + p_complex[n, 3], gamma_complex) - w2c - w1c;
    real w4c = pweight(p_complex[n, 1] + p_complex[n, 2] + p_complex[n, 3] + p_complex[n, 4], gamma_complex) - w3c - w2c - w1c;
    real w5c = pweight(p_complex[n, 1] + p_complex[n, 2] + p_complex[n, 3] + p_complex[n, 4] + p_complex[n, 5], gamma_complex) - w4c - w3c - w2c - w1c;
    real w6c = pweight(p_complex[n, 1] + p_complex[n, 2] + p_complex[n, 3] + p_complex[n, 4] + p_complex[n, 5] + p_complex[n, 6], gamma_complex) - w5c - w4c - w3c - w2c - w1c;
    ...
    u_simple[n] = pweight(p_simple[n, 1], gamma_simple) * pow(o_simple[n, 1], beta) +
                  (1 - pweight(p_simple[n, 1], gamma_simple)) * pow(o_simple[n, 2], beta);
